-- # SELECT from NOBEL tutorial - In this tutorial we will use the SELECT command on the table nobel

-- # Table nobel contains: yr, subject, winner
...
-- Show the the most recent first (year), then by name order
